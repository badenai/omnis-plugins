...
**Ignore:**
- Discretionary visual interpretation of order flow heatmaps, footprint charts, or GUI-based DOM trading (all advanced liquidity visualizations must be strictly reduced to mathematical thresholds and array computations)
