...
- Programmatic feature extraction from Order Flow Heatmaps (translating visual Bookmap-style liquidity clustering into n-dimensional data arrays for algorithmic consumption)
